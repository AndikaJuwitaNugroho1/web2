...
<body>
	...
	<?php
		include 'koneksi.php';
		$no = $_GET['no'];
		$data = mysqli_query($con,"select * from data_pendaftar where no='$no'");
		while($d = mysqli_fetch_array($data)){
	?>

	<h3><p align="center"><big>Form Edit Data Pemantauan Covid-19</big><br/></p></h3>
	...
	<table width="500" border="0" align="center" cellpadding="0" cellspacing="1">
	    ...
	    <tr>
	        ...
	        <td><input type="text" name="jumlah_positif" size="20" required="" value="<?php echo $d['jumlah_positif'] ?>"></td>
	    </tr>
	    <tr>
	        <td>Jumlah Dirawat</td>
	        <td><input type="text" name="jumlah_dirawat" size="20" required="" value="<?php echo $d['jumlah_dirawat'] ?>"></td>
	    </tr>
	    <tr>
	        <td>Jumlah Sembuh</td>
	        <td><input type="text" name="jumlah_sembuh" size="20" required="" value="<?php echo $d['jumlah_sembuh'] ?>"></td>
	    </tr>
	    <tr>
	        <td>Jumlah Meninggal</td>
	        <td><input type="text" name="jumlah_meninggal" size="20" required="" value="<?php echo $d['jumlah_meninggal'] ?>"></td>
	    </tr>
	    <tr>
	        <td>&nbsp;</td>
